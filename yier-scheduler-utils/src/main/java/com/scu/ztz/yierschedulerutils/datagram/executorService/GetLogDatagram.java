...
public class GetLogDatagram extends ExecutorServiceDatagram{

    @Override
    public String getType() {
        return ExecutorServiceEnums.GET_LOG;
    }
    
    public static GetLogDatagram fromJson(String json) {
        return GsonTool.fromJson(json, GetLogDatagram.class);
    }
}
