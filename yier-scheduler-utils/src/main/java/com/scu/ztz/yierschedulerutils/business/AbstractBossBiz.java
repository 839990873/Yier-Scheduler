...
public abstract class AbstractBossBiz implements BizHandler{
    ...
    public abstract ReturnDatagram registry(RegistryDatagram datagram);
    public abstract ReturnDatagram registryRemove(RegistryRemoveDatagram datagram);
    public abstract ReturnDatagram callback(CallBackDatagram datagram);
